...
- 1 【推荐算法+可视化+支付宝沙箱支付+LSTM+BP神经网络情感分析】vue+flask 图书大数据+书评+情感分析源码 协同过滤+爬虫 全套 *（待立项）*
- 2 【推荐算法+可视化+支付宝沙箱支付+LSTM+BP神经网络情感分析】vue+flask 影评大数据+情感分析源码 协同过滤+爬虫 全套 *（开发中，启动时间：2022年4月14日）*
